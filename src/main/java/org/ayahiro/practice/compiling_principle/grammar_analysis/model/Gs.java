...
// 核心逻辑  计算FIRST FOLLOW SELECT 生成预测分析表
public class Gs {
    ...
    public void showFirst() {
        ...
        for (Character c : keySet) {
            ...
            TreeSet<Character> value = firstMap.get(c);
    ...
    public void showFollow() {
        ...
        for (Character c : keySet) {
            ...
            TreeSet<Character> value = followMap.get(c);
            System.out.println(value.toString());
        }
        System.out.println();
    }
    ...
    public void showSelect() {
        ...
        Set<Character> keySet = selectMap.keySet();
        for (Character c : keySet) {
            HashMap<String, TreeSet<Character>> value = selectMap.get(c);
            Set<String> rightPartSet = value.keySet();
            for (String rightPart : rightPartSet) {
                System.out.print("SELECT( " + c + "->" + rightPart + " ) = ");
                System.out.println(value.get(rightPart).toString());
            }
        }
        System.out.println();
    }
